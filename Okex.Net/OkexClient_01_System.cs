...
namespace Okex.Net
{
    public partial class OkexClient : IOkexClientSystem
    {
        ...
        /// <returns></returns>
        public virtual WebCallResult<OkexSystemTime> SystemTime(CancellationToken ct = default) => SystemTime_Async(ct).Result;
        /// <summary>
        /// API server time. This is a public endpoint, no verification is required.
        /// </summary>
        /// <param name="ct">Cancellation Token</param>
        ...
        /// <param name="ct">Cancellation Token</param>
        /// <returns></returns>
        public virtual WebCallResult<IEnumerable<OkexSystemStatus>> SystemStatus(OkexSystemMaintenanceStatus? status = null, CancellationToken ct = default) => SystemStatus_Async(status, ct).Result;
        /// <summary>
        /// Gets status of system upgrade and maintenance
        /// </summary>
        /// <param name="status">System maintenance status 0: waiting; 1: processing; 2: completed If this parameter is not filled, the data with status 0 and 1 will be returned by default</param>
        /// <param name="ct">Cancellation Token</param>
        /// <returns></returns>
        public virtual async Task<WebCallResult<IEnumerable<OkexSystemStatus>>> SystemStatus_Async(OkexSystemMaintenanceStatus? status = null, CancellationToken ct = default)
        {
