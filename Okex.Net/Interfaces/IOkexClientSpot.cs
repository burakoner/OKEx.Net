...
namespace Okex.Net.Interfaces
{
    ...
    {
        WebCallResult<OkexSpotAlgoCancelledOrder> Spot_AlgoCancelOrder(string symbol, OkexAlgoOrderType type, IEnumerable<long> algo_ids, CancellationToken ct = default);
        Task<WebCallResult<OkexSpotAlgoCancelledOrder>> Spot_AlgoCancelOrder_Async(string symbol, OkexAlgoOrderType type, IEnumerable<long> algo_ids, CancellationToken ct = default);
        WebCallResult<Dictionary<string, IEnumerable<OkexSpotAlgoOrder>>> Spot_AlgoGetOrders(string symbol, OkexAlgoOrderType type, OkexAlgoStatus? status = null, IEnumerable<long> algo_ids = null, int limit = 100, long? before = null, long? after = null, CancellationToken ct = default);
        Task<WebCallResult<Dictionary<string, IEnumerable<OkexSpotAlgoOrder>>>> Spot_AlgoGetOrders_Async(string symbol, OkexAlgoOrderType type, OkexAlgoStatus? status = null, IEnumerable<long> algo_ids = null, int limit = 100, long? before = null, long? after = null, CancellationToken ct = default);
