...
namespace Okex.Net.CoreObjects
{
    ...
    public class OkexSocketRequestArgument
    {
        ...
        [JsonProperty("uly", NullValueHandling = NullValueHandling.Ignore), JsonOptionalProperty]
        public string Underlying { get; set; }

        [JsonProperty("instId", NullValueHandling = NullValueHandling.Ignore), JsonOptionalProperty]
        public string InstrumentId { get; set; }

        [JsonProperty("instType", NullValueHandling = NullValueHandling.Ignore), JsonOptionalProperty, JsonConverter(typeof(InstrumentTypeConverter))]
    ...
    {
        [JsonProperty("apiKey", NullValueHandling = NullValueHandling.Ignore), JsonOptionalProperty]
        public string ApiKey { get; set; }

        [JsonProperty("passphrase", NullValueHandling = NullValueHandling.Ignore), JsonOptionalProperty]
        public string Passphrase { get; set; }

        [JsonProperty("timestamp", NullValueHandling = NullValueHandling.Ignore), JsonOptionalProperty]
        public string Timestamp { get; set; }

        [JsonProperty("sign", NullValueHandling = NullValueHandling.Ignore), JsonOptionalProperty]
