...
namespace Okex.Net
{
    public partial class OkexClient : IOkexClientSpot
    {
        ...
        /// <param name="ct">Cancellation Token</param>
        /// <returns></returns>
        public WebCallResult<OkexSpotAlgoPlacedOrder> Spot_AlgoPlaceOrder(
            /* General Parameters */
            string symbol,
        ...
        /// <param name="ct">Cancellation Token</param>
        /// <returns></returns>
        public async Task<WebCallResult<OkexSpotAlgoPlacedOrder>> Spot_AlgoPlaceOrder_Async(
            /* General Parameters */
            string symbol,
            OkexAlgoOrderType type,
            OkexMarket mode,
