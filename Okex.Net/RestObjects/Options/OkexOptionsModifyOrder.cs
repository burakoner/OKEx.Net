...
{
    public class OkexOptionsModifyOrder
    {
        /// <summary>
        /// When the order modification fails, whether the order needs to be automatically cancelled. 0: No automatic order cancellation 1: Automatic order cancellation The default is 0
        /// </summary>
