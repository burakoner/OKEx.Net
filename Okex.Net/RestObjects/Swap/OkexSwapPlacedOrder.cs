...
{
    public class OkexSwapBatchPlacedOrder
    {
        [JsonProperty("result")]
    ...
    public class OkexSwapPlacedOrder
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("error_code"), JsonOptionalProperty]
        public string ErrorCode { get; set; } = "";

        /// <summary>
        /// Error message will be returned if order placement fails, otherwise it will be blank
        /// </summary>
        [JsonProperty("error_message"), JsonOptionalProperty]
